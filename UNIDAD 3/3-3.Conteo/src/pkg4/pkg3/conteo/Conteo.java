...
public class Conteo {
    ...
    public static void menu(int [] sexo, int [] trabajo){
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            System.out.println("Ingresa  cantidad de sueldo... si no trabajas ingresa 0");
                nsueldo = ent.nextInt();
                if (nsueldo == 0) {
                    sinsueldo++;
            }else{
        ...
        System.out.println("-----------------------------------------------");
        System.out.println("Porcentaje de hom que no trabajan: "+pht+"%");
        System.out.println("Porcentaje de muj que no trabajan: "+pmt+"%");
        System.out.println("Sueldo promedio de los hom: $"+sph);
        System.out.println("Sueldo promedio de las muj: $"+spm);
    }
